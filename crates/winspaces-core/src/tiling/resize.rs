...
mod tests {
    ...
    fn horizontal_split_0_ratio_drag_adjusts_ratio() {
        ...
        let outcome = classify_drag(w0, &t0, &new_rect, &tiles, (1200, 500));
    ...
    fn drag_onto_another_tile_swaps() {
        ...
        let outcome = classify_drag(w0, &t0, &moved_rect, &tiles, (1400, 500));
    ...
    fn drop_outside_or_same_tile_snaps_back() {
        ...
        let outcome_outside = classify_drag(w0, &t0, &moved_rect, &tiles, (2500, 500));
        assert_eq!(outcome_outside, DragOutcome::SnapBack);

        // Dropped inside own tile
        let outcome_own = classify_drag(w0, &t0, &moved_rect, &tiles, (400, 500));
