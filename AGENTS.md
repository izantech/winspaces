...
- [`site/`](site): the winspaces.app landing page, plain static files
  ...
  previews it. [`assets/`](assets): the logo, and
  `crates/winspaces/winspaces.ico` the exe icon, both generated by
  `scripts/gen-icon.py` — edit the spec there, never the outputs.
- Package managers: winget (`.github/workflows/winget.yml`) and crates.io
  (`.github/workflows/crates.yml`), both on *release published*; details in
  `docs/distribution.md` §4. Chocolatey is deliberately not set up.
