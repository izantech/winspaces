...
- Package managers: winget (`.github/workflows/winget.yml` after a manual
  first submission) and crates.io (publish order in `docs/distribution.md`
  §4). Chocolatey is deliberately not set up.
